...
export default function Home() {
  return (
    <main>
        ...
        <div className="flex flex-col items-center ">
          ...
          <div className="mt-10 md:w-[90%] overflow-hidden rounded-3xl drop-shadow-xl">
            <Image
              width={1000}
              height={1000}
              alt="Cyntonisca Case Management"
              className="w-full h-full object-cover"
              priority={true}
      ...
      <section className="py-6 px-5 md:px-[50px] lg:px-[50px] xl:px-[50px]">
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-[2rem] font-semibold">Recent Articles</h5>
          <Link href={"/blog"}>
            <AppButton className="!bg-[#f5f5f5] !text-primary px-[10px] !w-max">
              <span className="underline">All Articles</span>
            </AppButton>
          </Link>
        </div>
        <RecentPosts />
